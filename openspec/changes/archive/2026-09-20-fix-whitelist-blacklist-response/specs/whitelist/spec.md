# whitelist Specification (Delta)

## ADDED Requirements

### Requirement: Whitelist list endpoint returns PagedResponse
El endpoint `GET /api/v1/whitelist` ahora devuelve un `PagedResponse` envolviendo el array de entries, para compatibilidad con el frontend.

#### Scenario: List all whitelist entries returns PagedResponse
...
#### Scenario: Empty whitelist returns PagedResponse with empty data
