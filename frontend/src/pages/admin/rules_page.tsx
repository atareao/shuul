...
const FIELDS: FieldDefinition<Item>[] = [
    ...
    { key: 'rate_limit_enabled', label: 'Rate Limit', type: 'boolean', value: false, width: 100, visible: true, help: 'Enable rate limiting for this rule' },
    { key: 'max_retry', label: 'Max Retry', type: 'number', value: 5, width: 100, visible: true, min: 1, help: 'Requests allowed before ban' },
    { key: 'find_time_seconds', label: 'Find Time (s)', type: 'number', value: 600, width: 120, visible: true, min: 1, help: 'Sliding window in seconds' },
    { key: 'ban_time_seconds', label: 'Ban Time (s)', type: 'number', value: 3600, width: 120, visible: true, min: 1, help: 'Base ban duration in seconds' },
    { key: 'bantime_increment', label: 'Escalate', type: 'boolean', value: false, width: 100, visible: true, help: 'Increase ban time for repeat offenses' },
    { key: 'bantime_multipliers', label: 'Multipliers', type: 'string', value: "1,2,4,8", width: 120, visible: true, help: 'Comma-separated values, e.g. 1,2,4,8' },
    { key: 'bantime_maxtime_seconds', label: 'Max Ban (s)', type: 'number', value: 604800, width: 120, visible: true, min: 1, help: 'Upper limit for escalated bans' },
    { key: 'ban_count_decay_days', label: 'Decay (d)', type: 'number', value: 30, width: 100, visible: true, min: 1, help: 'Days before escalation resets' },
    { key: 'ignoreip', label: 'Ignore IPs', type: 'string', value: "", width: 150, visible: true, help: 'Comma-separated IP addresses to ignore' },
    { key: 'webhook', label: 'Webhook', type: 'string', value: "", width: 200, visible: true, help: 'Optional HTTP(S) endpoint called for ban events' },
];
