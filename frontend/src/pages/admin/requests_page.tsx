...
const RecordsFields: FieldDefinition<Item>[] = [
    ...
    { key: 'method', label: 'Method', type: 'string', filterKey: 'method', width: 100 },
    { key: 'user_agent', label: 'User Agent', type: 'string', filterKey: 'user_agent', width: 200 },
    { key: 'referer', label: 'Referer', type: 'string', filterKey: 'referer', width: 200 },
    { key: 'content_type', label: 'Content Type', type: 'string', filterKey: 'content_type', width: 150 },
    { key: 'accept_language', label: 'Accept Language', type: 'string', filterKey: 'accept_language', width: 150 },
    { key: 'x_request_id', label: 'X-Request-ID', type: 'string', filterKey: 'x_request_id', width: 180 },
